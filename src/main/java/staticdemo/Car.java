...
public class Car extends DriveCar{//if this class is final it won't be possible to be extended in class Tesla
    private String color; //nonstatic
    protected static int counter; //static variable
    ...
    static{
        ...
        //FOUR_WHEEL_DRIVE = true; //mandatory either here or when defined
